...
public interface FreteClient {
    ...
    List<FreteResponse> getFrete(@RequestBody FreteRequest request, @RequestHeader("Authorization") String authorization, @RequestHeader("User-Agent") String userAgent);
}
